...
export default {
  ...
  callback: async ({
    ...
    try {
      ...
      return "Invalid time format! Example format: \"10d\" where 'd' = days, 'h' = hours and 'm' = minutes, 's' = seconds.";
    }
    if (type === "s") {
      time /= 60;
    } else if (type === "h") {
      ...
      return 'Please use "s" "m", "h", or "d" for seconds, minutes, hours and "days" respectively.';
    }
